...
if ($obSession->has('typeOfView')) $typeOfView = $obSession->get('typeOfView');
?>

<div class="announcements-switch">
    <div id="ads-list" class="announcements-switch__item switch-list <?=$typeOfView === 'ads-list' ? 'active' : ''?>">
    ...
    <div id="ads-card" class="announcements-switch__item switch-card <?=$typeOfView === 'ads-card' ? 'active' : ''?>">
